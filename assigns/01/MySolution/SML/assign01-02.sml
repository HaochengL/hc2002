...
(xs: 'a xlist, i0: int): 'a = 
    case xs of 
        ...
        | xlist_append(x1,x2) => if i0<= 0 then xlist_sub(x1,0) else if i0 > xlist_size(x1) + xlist_size(x2) then raise XlistSubscript else if i0 > xlist_size(x1)-1 then xlist_sub(x2,i0-xlist_size(x1)) else xlist_sub(x1,i0)
